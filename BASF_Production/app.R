...
#library(plotly)
customerInputTable = data.table::fread("./Data/Customer Onboarding Information_BASF_Nov2024.csv", skip=1)
...
server <- function(input, output, session) {
  ...
  climateArray = readRDS("./Data/BASF_Nov2024_regional_rawValues.rds")
  indexArray = readRDS("./Data/BASF_Nov2024_local_waterIndex.rds")
  watershedIndexArray = readRDS("./Data/BASF_Nov2024_regional_waterIndex.rds")
  graceHistorical = data.table::fread("./Data/BASF_Nov2024_graceHistorical.csv")
  basinSummary_ws = data.table::fread("./Data/BASF_Nov2024_regional_hydroBasins_wIndex.csv")
  basinSummary = data.table::fread("./Data/BASF_Nov2024local_hydroBasins_wIndex.csv")
  basinSummary$AridityIndex = basinSummary$currentPrecip_avg / basinSummary$currentPET_avg
  basinShapes = sf::st_read("./Data/BASF_Nov2024_hydroBasins_shapesOnly.shp")
